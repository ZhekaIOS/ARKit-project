...
//        sceneView.debugOptions = [ARSCNDebugOptions.showFeaturePoints]
   ...
   //     sceneView.autoenablesDefaultLighting = true
    ...
    func createVirtualObject(hitResult: ARHitTestResult) {
        ...
        if let particleSystem2 = SCNParticleSystem(named: "snow", inDirectory: nil), let snowNode = virtualObject.childNode(withName: "RainNode", recursively: true) {
            snowNode.addParticleSystem(particleSystem2)
        }
